...
const Gallery = (props) => {
    ...
    <img src={props.images[props.index]} alt="" /></div>
    ...
    {props.isAuth && <div className={s.bottomGallery} >  <div onClick={props.handleDeleteImage} className={s.deleteButton} > Удалить фото <img src={deleteIcon} alt="" /></div>   </div>} 
